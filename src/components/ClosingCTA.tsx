...
export default function ClosingCTA({ waNumber }: ClosingCTAProps) {
  return (
    <section className="w-full bg-white px-6 py-20 dark:bg-[#120d18]" data-aos="fade-up">
      <div className="landing-content-narrow motion-card rounded-4xl border border-brand-purple/10 bg-brand-cream/60 px-8 py-12 text-center shadow-[0_24px_80px_rgba(81,12,102,0.08)] dark:border-white/10 dark:bg-white/5 dark:shadow-[0_24px_80px_rgba(0,0,0,0.32)]">
